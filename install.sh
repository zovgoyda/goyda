...
sudo pacman -Syu --needed niri kitty fastfetch btop zsh thunar firefox cmake wl-clipboard kdeconnect greetd greetd-dinit xdg-desktop-portal-gnome rust lact lact-dinit git libcanberra ttf-jetbrains-mono noto-fonts-cjk jq xlibre-xserver-common nwg-look turnstile-dinit dbus-dinit pipewire-dinit pipewire-pulse-dinit wireplumber-dinit feh glu mpv glew xwayland-satellite keepassxc
